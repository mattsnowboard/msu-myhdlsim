...
class TestNorGate(TestCase):
        ...
        def test(out, a, b):
            ...
            for i in range(2):
                ...
                for j in range(2):
                    ...
                    yield delay(10)
                    #print a, b, out
                    self.assertEqual(not(a or b), out)
            ...
            for i in range(2):
                ...
                for j in range(2):
                    ...
                    for k in range(2):
                        ...
                        yield delay(10)
                        #print a, b, c, out
                        self.assertEqual(not(a or b or c), out)
                ...
                for j in range(2):
                    ...
                    for k in range(2):
                        ...
                        for k in range(2):
                            ...
                            yield delay(10)
                            #print a, b, c, d, out
                            self.assertEqual(not(a or b or c or d), out)

        a, b, c, d, out = [Signal(None) for i in range(5)]
        gate = Nor(out, a, b, c, d)
        check = test(out, a, b, c, d)
        sim = Simulation(gate, check)
        sim.run(quiet=1)

    def testUndefinedOneOfTwo(self):
        """ Make sure NOR gate properly outputs None when given None """
        def test(out, a, b):
            yield delay(10)
            for i in range(2):
                a.next = i
    ...
    def testUndefinedOneOfFour(self):
        """ Make sure NOR gate properly outputs None when given None for 4 bits """
        def test(out, a, b, c, d):
            yield delay(10)
            for i in range(2):
                a.next = i

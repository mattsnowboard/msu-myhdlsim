...
class TestAndGate(TestCase):
            ...
            for i in range(2):
                ...
                for j in range(2):
                    ...
                    for k in range(2):
                        ...
                        yield delay(10)
                        #print a, b, c, out
                        self.assertEqual(a and b and c, out)
                ...
                for j in range(2):
                    ...
                    for k in range(2):
                        ...
                        for l in range(2):
                            ...
                            yield delay(10)
                            #print a, b, c, d, out
                            self.assertEqual(a and b and c and d, out)

        a, b, c, d, out = [Signal(None) for i in range(5)]
        gate = And(out, a, b, c, d)
    ...
    def testUndefinedOneOfFour(self):
        """ Make sure AND gate properly outputs None when given None for 4 bits """
        def test(out, a, b, c, d):
            yield delay(10)
            for i in range(2):
                a.next = i
